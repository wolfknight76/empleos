...
public class SolicitudesController {
	...
	public String mostrarIndex(Model model) {
		List<Solicitud> lista = serviceSolicitudes.listar();
		model.addAttribute("solicitudes", lista);
		model.addAttribute("titulo", "EmpleosApp | Listado de Solicitudes de Empleo");
	...
	public String mostrarIndexPaginado(Model model, Pageable page) {
		Page<Solicitud> lista = serviceSolicitudes.listar(page);
		model.addAttribute("solicitudes", lista);
		model.addAttribute("titulo", "EmpleosApp | Listado de Solicitudes de Empleo");
		return "solicitudes/listSolicitudes";
	}
	...
	public String crear(Solicitud solicitud, @PathVariable Integer idVacante, Model model) {
		...
		model.addAttribute("titulo", "EmpleosApp | Aplicar para una Oferta de Trabajo");
